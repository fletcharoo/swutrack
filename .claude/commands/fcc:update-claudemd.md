...
2. **Update Important Files:** Update the `Important Files` section of the `CLAUDE.md` file. Include the path to the file and single sentence description of the purpose of the file.
